...
{/*export const CovidInfoIcon = ({className}) =>{
    return(
        <img
            className={className}
...
export const FriendsSidebarIcon = ({className}) =>{
    return(
        <img
            className={className}
...
export const GroupsSidebarIcon = ({className}) =>{
    return(
        <img
            className={className}
...
export const MarketSidebarIcon = ({className}) =>{
    return(
        <img
            className={className}
...
export const MessengerSidebarIcon = ({className}) =>{
    return(
        <img
            className={className}
...
export const MediaVideoIcon = ({className}) => {
    return (
        <svg 
            viewBox="0 0 28 28" 
            className={className}
